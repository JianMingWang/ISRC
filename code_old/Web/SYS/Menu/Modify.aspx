            ...
            <Items>
                <f:Form ID="formInfo_01" ShowBorder="false" LabelAlign="left" ShowHeader="false" runat="server"
                    ...
                    <Rows>
                        <f:FormRow>
                            <Items>
                                <f:TextBox ID="txbMenuName" Label="菜单名称" Width="250px" LabelWidth="70px" Required="true" runat="server"></f:TextBox>
                                <f:DropDownList ID="ddlFatherMenu" Label="上级菜单" Width="250px" LabelWidth="70px" Required="true" runat="server">
                                </f:DropDownList>
                            </Items>
                        </f:FormRow>
                         <f:FormRow>
                            <Items>
                                <f:TextBox ID="txbMenuUrl" Label="URL" Width="250px" Enabled="false" LabelWidth="70px" Required="true" runat="server"></f:TextBox>
